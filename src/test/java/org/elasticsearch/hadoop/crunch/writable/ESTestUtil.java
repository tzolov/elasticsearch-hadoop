...
public class ESTestUtil {
  ...
  public static void populateESWithTestTwittData(EmbeddedElasticsearchServer esServer) throws ElasticSearchException,
      IOException {
  ...
  public static void checkResultTwitterIndex(EmbeddedElasticsearchServer esServer) {
